...
import SermonImg from '../assets/images/JCCI The Word Page 1 (9).png'
import Image from '../assets/images/Rectangle 10.png'
import Youtube from '../assets/images/youtube.png'
import Whatsapp from '../assets/images/WhatsApp_Image_2021-08-10_at_2.22 1.png'
                        ...
                        <div className="upload-link">
                            ...
                            <form onSubmit={handleSubmit}>
                             ...
                             <div className="giving-button">
                                ...
                                <p>Upload Church Website Link</p>
                            <form onSubmit={handleSubmit}>
                                <div className="form-contents">
                                    <img src={Whatsapp} alt="cards" className='zelle'/>
                                        <input 
                                        type="text" 
                                        name="name" 
                                        value={state.name}  
