...
import SermonImg from '../assets/images/JCCI The Word Page 1 (12).png'
import Image from '../assets/images/Rectangle 10.png'

function DiscoverFaith() {
                    ...
                    <div className="card__body">
                        <div className="upload-event">
                            ...
                            <div className="member-file">
                               { file && <img src={preview} alt={file.name} style={{width: "195px", height: "266px", marginLeft:"2px", marginTop:"-8px", borderRadius: "6px", border: "1px solid #C4C4C4", marginBottom:"5px"}} />
                                } 
